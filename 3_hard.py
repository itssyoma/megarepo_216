...
# правильность загружаемых данных формата JSON. В следствие чего, необходимо после
# загрузки из файла JSON выполнять валидацию загруженных данных. Валидацию данных
# необходимо производить с использованием спецификации JSON Schema, описанной
# на сайте https://json-sch ema.org/. Одним из возможных вариантов работы с JSON
# Schema является использование пакета jsonschema , который не является частью
# стандартной библиотеки Python. Таким образом, необходимо реализовать валидацию
# загруженных данных с помощью спецификации JSON Schema.
